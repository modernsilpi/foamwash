...
function Home() {
    return (
        <div style={{background: "rgba(19, 19, 19, 0.4)", width: "100%", height: "720px"}}>
           <p style={{ width: "100%", color: "rgb(235, 245, 250)", paddingTop: "80px", fontSize: "53px", textAlign: "center"}}> Hello viagites!</p>
